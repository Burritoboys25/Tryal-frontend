  ...
  return (
    ...
    >
      ...
      {orientation === 'horizontal' && (
        <ScrollBar orientation="horizontal" className="-mr-[0.5rem]" />
      )}
      {orientation === 'vertical' && <ScrollBar orientation="vertical" className="-mr-[0.5rem]" />}
...
function ScrollBar({
  ...
  // Add a light gray background to the scrollbar track
  return (
