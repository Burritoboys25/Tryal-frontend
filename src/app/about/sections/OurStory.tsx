  ...
  return (
    <Section id="our-story" background="white" className="min-h-screen space-y-[4rem]">
      ...
      <div className="mx-auto space-y-4 pt-10 text-left md:pt-15 md:text-center xl:w-[85%] xl:pt-20 2xl:pt-15">
        ...
        <div className="relative flex h-[20rem] items-center justify-center overflow-hidden rounded-[.75rem] xl:h-[30rem] 2xl:h-[36rem]">
          <Image src="/about_us/teampic.png" alt="Team Photo" fill className="object-cover scale-110" />
        </div>
      ...
      {/* Mission */}
      <div className="relative mx-auto flex flex-col items-stretch justify-between gap-[1rem] md:flex-row md:gap-[2rem] xl:w-[90%] 2xl:w-[88%]">
        {/* Left: Mission Text */}
      ...
      {/* Vision */}
      <div className="relative mx-auto flex flex-col-reverse items-stretch justify-between gap-[1rem] md:flex-row md:gap-[2rem] xl:w-[90%] 2xl:w-[88%]">
        {/* Left: Images */}
        <div className="relative flex items-center justify-center">
          <BlurBackground className="absolute top-1/2 left-1/2 h-[21.875rem] w-[21.875rem] -translate-x-1/2 -translate-y-1/2" />
          <Image
